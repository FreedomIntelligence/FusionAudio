...
class WavCaps_aqa_test_dataset(object):
    """
...
if __name__ == '__main__':
    reference_file = '/wangbenyou/xinyuan/ECHO-AQA/data/eval/instruction_ref/wavcaps_qa_test.json'

    output_dir = '/wangbenyou/xinyuan/ECHO-AQA/results/WavCapsQA/WavCapsqa_echo/'
    prediction_file = output_dir+'t-0.1.json'
    os.makedirs(output_dir, exist_ok=True)
    # Update output filenames
    results_output_file = os.path.join(output_dir, 'WavCaps_aqa_llm_judge_results.json')
    details_output_file = os.path.join(output_dir, 'WavCaps_aqa_llm_judge_details.json')
    ...
    evaluator = WavCaps_aqa_test_dataset(number_of_samples=-1) # Use all aligned groups
